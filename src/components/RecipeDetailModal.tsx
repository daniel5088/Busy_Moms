...
export function RecipeDetailModal({ recipe, onClose, onIngredientsAdded, onRecipeDeleted }: RecipeDetailModalProps) {
  ...
  const addSelectedToShoppingList = async () => {
    ...
    try {
      ...
      const shoppingItems: Omit<ShoppingItem, 'id' | 'created_at' | 'updated_at'>[] =
      ...
      const { error } = await supabase.from('shopping_lists').insert(shoppingItems);
        ...
        const response = await instacartService.createRecipePage({
          ...
          ingredients: ingredients.map((ing) => ({
            ...
            quantity: ing.quantity
              ? parseFloat(getAdjustedQuantity(ing.quantity) || '0')
              : undefined,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6 text-gray-600">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button onClick={() => adjustServings(1)} className="p-1 hover:bg-gray-100 rounded">
          ...
          {recipe.author && <p className="text-gray-600">By {recipe.author}</p>}
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
            ...
            >
              ...
              <span>Add {selectedIngredients.size} to Shopping List</span>
            </button>
