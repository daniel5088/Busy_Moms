/**
 * Database type definitions for Busy Moms Mobile
 * Ported from web app (Busy_Moms/src/lib/supabase.ts)
 * These types must stay synchronized with the Supabase database schema
 */
